          ...
          <div className="container mx-auto px-10" style={{ maxWidth: "860px" }}>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "clamp(2rem,4vw,4rem)" }}>
              ...
              <div>
                {sent ? (
                  <div style={{ padding: "2rem", backgroundColor: "#f0fdf4", border: "1px solid #6ee7b7", borderRadius: "1rem", textAlign: "center" }}>
                    ...
                    <p style={{ fontSize: "1rem", color: "#4a5568" }}>We'll be in touch within one business day.</p>
                  </div>
                ) : (
                  <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                    {[
                      ...
                      <div key={key}>
                        <label style={{ display: "block", fontSize: "1rem", fontWeight: 600, color: "#374151", marginBottom: "0.375rem" }}>{label}</label>
                        <input
                          type={type}
                          ...
                          required
                          style={{ width: "100%", padding: "0.75rem 1rem", border: "1px solid #d1d5db", borderRadius: "0.625rem", fontSize: "1.0625rem", color: "#111827", outline: "none", boxSizing: "border-box", backgroundColor: "#ffffff" }}
                        />
                      </div>
                    ))}

                    <div>
                      <label style={{ display: "block", fontSize: "1rem", fontWeight: 600, color: "#374151", marginBottom: "0.375rem" }}>What are you reaching out about?</label>
                      <select
                        value={form.topic}
                        onChange={e => setForm(f => ({ ...f, topic: e.target.value }))}
                        required
                        style={{ width: "100%", padding: "0.75rem 1rem", border: "1px solid #d1d5db", borderRadius: "0.625rem", fontSize: "1.0625rem", color: form.topic ? "#111827" : "#9ca3af", outline: "none", backgroundColor: "#ffffff", boxSizing: "border-box" }}
                      >
                    ...
                    <div>
                      <label style={{ display: "block", fontSize: "1rem", fontWeight: 600, color: "#374151", marginBottom: "0.375rem" }}>Message</label>
                      <textarea
                        value={form.message}
                        onChange={e => setForm(f => ({ ...f, message: e.target.value }))}
                        placeholder="Tell us about your environment or what you're trying to solve..."
                        rows={4}
                        style={{ width: "100%", padding: "0.75rem 1rem", border: "1px solid #d1d5db", borderRadius: "0.625rem", fontSize: "1.0625rem", color: "#111827", outline: "none", resize: "vertical", boxSizing: "border-box", backgroundColor: "#ffffff" }}
                      />
                    </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "1.75rem", paddingTop: "0.5rem" }}>
                <div>
                  <div style={{ fontSize: "1rem", fontWeight: 700, color: "#111827", marginBottom: "0.75rem" }}>Direct contact</div>
                  <a href="mailto:info@unkov.com" style={{ display: "flex", alignItems: "center", gap: "0.75rem", fontSize: "1.0625rem", color: "#0061d4", textDecoration: "none", fontWeight: 500 }}>
                    <Mail style={{ width: 16, height: 16 }} /> info@unkov.com
                  </a>
                </div>

                <div>
                  <div style={{ fontSize: "1rem", fontWeight: 700, color: "#111827", marginBottom: "0.75rem" }}>Follow us</div>
                  <a href="https://linkedin.com/company/unkov" target="_blank" rel="noopener noreferrer" style={{ display: "flex", alignItems: "center", gap: "0.75rem", fontSize: "1.0625rem", color: "#0061d4", textDecoration: "none", fontWeight: 500 }}>
                ...
                <div style={{ backgroundColor: "#f0ece6", borderRadius: "1rem", padding: "1.5rem", border: "1px solid #dcd6ce" }}>
                  <div style={{ fontSize: "1rem", fontWeight: 700, color: "#111827", marginBottom: "0.5rem" }}>Design partner program</div>
                  <p style={{ fontSize: "1rem", color: "#4a5568", lineHeight: 1.7, marginBottom: "1rem" }}>
                  ...
                  <a href="/early-access" style={{ fontSize: "1rem", fontWeight: 600, color: "#00297a", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: "0.375rem" }}>
                    Apply for pilot <ArrowRight style={{ width: 13, height: 13 }} />
                  </a>
                </div>

                <div>
                  <div style={{ fontSize: "1rem", fontWeight: 700, color: "#111827", marginBottom: "0.375rem" }}>Response time</div>
                  <p style={{ fontSize: "1rem", color: "#6b7280" }}>We respond to all inquiries within one business day.</p>
                </div>
              </div>

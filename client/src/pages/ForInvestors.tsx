        ...
        <section className="section border-b border-[#d8dde6]" style={{ backgroundColor: "#f6f8fa" }}>
          <div className="container mx-auto px-10">
            ...
            <div className="grid md:grid-cols-2 gap-5 mb-8">
              {[
                { icon: Brain,     n: "01", color: "#0061d4", title: "Discover — Identity Graph",      desc: "Zero-touch scan across 20 connectors builds a live identity graph — every human, bot, AI agent, and service account mapped with their relationships. Live dashboard in under 30 minutes.", access: "Read-Only / Auditor" },
                { icon: Zap,       n: "02", color: "#10b981", title: "Analyze — Risk Engine",          desc: "Every identity scored continuously across three dimensions: behavior, permissions, and relationships. Risk scores update in real time as events happen. AI agents explain every finding in plain English.", access: "Telemetry & Metadata Access" },
                { icon: Radio,     n: "03", color: "#f59e0b", title: "Enforce — AI Proxy + Gate",      desc: "AI Proxy routes all LLM calls through Unkov — identity checked before any model is invoked. The enforcement gate verifies every login and every API call in real time before execution.", access: "Restricted Write (scoped)" },

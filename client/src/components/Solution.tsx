...
export default function Solution() {
  const modules = [
    ...
    },
    {
      ...
      features: ["Continuous risk scoring across behavior, permissions, and relationships", "Risk scores update in seconds when events happen — not nightly batches", "AI-powered analysis explains every finding in plain English"],
    },
    {
      icon: Shield,
      number: "03",
